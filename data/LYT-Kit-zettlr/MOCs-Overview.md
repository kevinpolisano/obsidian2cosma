...
Whenever you start to feel that tickle of overwhelm ([Mental Squeeze Point]([[20220627045431]])), that's when you need to *become a cartographer of your own content* and create a new MOC. 
...
8. MOCs **allow for limitless flexibility**. Unlike folders or Table of Contents (TOC), MOCs are not hierarchical. They are [heterarchical]([[20220717193545]]). This means that different MOCs can map the same info in different ways, to fit whatever your current needs might be.
9. MOCs **encourage "Relational Positioning"**: Don't argue with the Ancient Greeks and Romans about the [value of spatial relationships]([[20220825050256]]). It helps us remember better when ideas are not floating in isolation, but as a part of a spatial constellation.